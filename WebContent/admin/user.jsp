                                    ...
                                    <table class="layui-table">
                                            ...
                                            <tbody>
                                                    <c:forEach items="${adminCommentList}" var="n">
                                                        <tr>
                                                                <td>
                                                                        <a href="${pageContext.request.contextPath}/UserAction.do?method=query&userId=${n.userId}">${n.name}</a>
                                                                </td>
                                                                <td>${n.email}</td>
                                                                <td>${n.phone}</td>
                                                                <td>${n.loginDate}</td>
                                                                ...
                                                                <td>
                                                                        <a class="layui-btn layui-btn-xs layui-bg-orange" href="javascript:;" onclick="getAdmin('adminBadUser', '${n.userId}')">封号</a>
                                                                </td>
                                                        </tr>
                                                    </c:forEach>
                                            </tbody>
