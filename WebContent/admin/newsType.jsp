        ...
        <head>
                ...
                <script>
                    function getAdmin(method, id) {
                        if (method == 'adminInsertNewsTypeId') {
                            layer.prompt({
                                maxlength: 25,
                                value: '',
                                title: '请输入类型名',
                                            ...
                                            <tbody>
                                                    <c:forEach items="${adminCommentList}" var="n">
                                                        <tr>
                                                                ...
                                                                <td>${n.body}</td>
                                                                <td>
                                                                        <a class="layui-btn layui-btn-xs layui-bg-orange" href="javascript:;" onclick="getAdmin('adminInsertNewsTypeId')">添加</a>
                                                                        <a class="layui-btn layui-btn-xs layui-bg-orange" href="javascript:;" onclick="getAdmin('adminRemoveNewsType', '${n.newsTypeId}')">删除</a>
                                                                </td>
                                                        </tr>
                                                    </c:forEach>
                                            </tbody>
